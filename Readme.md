...
- [x] if possible: change name of 13 sun to 14 sun
- [x] add supports for ltr browsers (images be in right side): browser syncs with language, if you choose "en" tabs are left and vice versa
